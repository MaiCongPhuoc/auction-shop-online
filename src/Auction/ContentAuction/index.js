...
function ContentAuctionDetail() {
    const settings = {
        ...
        customPaging: function (i) {
            return (
                <a className="slick-a">
                    {/* <img src={dataDigitalSelect[i].images} className="Slick-img" /> */}
            ...
            <div id="lot-body">
                        ...
                        <div className="reward-popup-mobile-full">
                            ...
                            <div className="reward-pp-left">
                                <img
                                    ...
                                    alt="Icon gift3x red"
                                    data-pagespeed-url-hash={2967187707}
                                    onload="pagespeed.CriticalImages.checkImageForCriticality(this);"
                                />
                            </div>
                            <div className="reward-pp-mid">
                                <div className="reward-pp-title">
                                    Watching? Bid Now, Get $<span className="reward-amount" />!
                                </div>
                                <div className="reward-pp-text">
                                    Bid before this lot closes and we'll give you $<span className="reward-amount" />
                                </div>
                            </div>
                        ...
                        <div className="reward-popup-mobile-small">
                            ...
                            <div className="reward-pp-sm-icon">
                                <img
                                    ...
                                    data-pagespeed-url-hash={550804067}
                                    onload="pagespeed.CriticalImages.checkImageForCriticality(this);"
                                />
                            </div>
                    ...
                    <div className="medium-7 medium-large-8 cell left-col">
                        <div className="lot-page-left">
                            <div className="lot-title">
                                <h2>
                                    Enjoy a Round of Golf at Bethpage Black Course with JetBlue Head of Security &amp;
                                    VP of Flight Operations with 2 JetBlue Roundtrip Travel Certificates
                                </h2>
                            </div>
                            ...
                            <div className="lot-image-showcase">
                                ...
                                {/* <div
                                        className="images-only-wrapper owl-carousel owl-theme"
                                ...
                                <Slider {...settings}>
                                    ...
                                    <div className="card">
                                        <div className="card-top">
                                            <img
                                                src="https://photo-cms-plo.epicdn.me/w850/Uploaded/2022/vocgmvbg/2020_03_24/truc-anh9_alig.jpg"
                                                alt="{item.title}"
                                                className='auctionImg'
                                            />
                                        </div>
                            ...
                            <div className="lot-detail">
                                    ...
                                    <div className="bidding-box-alt">
                                        ...
                                        <div className="bb-element">
                                            ...
                                            <div className="bb-item">
                                                <div className="current-bidder">
                                                    <div className="bb-title is-label">
                                                        ...
                                                        >
                                                            CURRENT BID <FontAwesomeIcon icon={faCircleInfo} />
                                                        </span>
                                                    </div>
                                                    <div className="bb-content">
                                            ...
                                            <div className="bb-item">
                                                ...
                                                <div className="bb-content">
                                                    <div className="est-val">$2,500</div>
                                                </div>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <span className="next-min-bid-label">Next minimum bid: &nbsp;</span>
                                        ...
                                        <div className="watchlist-action exp-1">
                                            <div className="watcher-btn">
                                                <a
                                                    ...
                                                    data-gtm-vis-has-fired-1128349_179={1}
                                                >
                                                    <div className="relative-wrapper watch-wrapper">
                                                        ...
                                                        >
                                                            <i className="fa-heart fal" aria-hidden="true" />
                                                        </b>
                                                    </div>
                                                    <span className="watch-type">Add to Watchlist</span>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div className="lot-content">
                                    <div className="item lot-overview active">
                                        <div className="lot-donator">Donated by: JetBlue</div>
                                        <div className="lot-description">
                                            <p>
                                                Hit the links with JetBlue’s Head of Safety, Security, &amp; Flight
                                                Operations Warren Christie and Vice President of Flight Operations Jeff
                                                Winter for a round of golf on the black course at Bethpage State Park in
                                                Long Island, New York.
                                            </p>
                                            <p>This package includes two JetBlue roundtrip travel</p>
                                        </div>
                                                ...
                                                <div className="new-terms-detail">
                                                    ...
                                                    <div className="new-terms-content">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                Airfare will occur within the following date range(s):{' '}
                                                                <br /> Oct 21, 2022 to Oct 06, 2023
                                                            </li>
                                                        </ul>
                            ...
                            <div className="bidding-actions">
                                ...
                                <div className="watchlist-action exp-1">
                                    ...
                                    <a
                                        ...
                                        data-item-id={2522828}
                                        data-item-slug="auction-enjoy-round-of-golf-at-bethpage-black-course-2522828"
                                        className="watch-button watcher-btn"
                                        style={{ border: 'none' }}
                                        href="/catalog_items/2522828/toggle_watch"
                                        data-gtm-vis-recent-on-screen-1128349_179={1809}
                                        data-gtm-vis-first-on-screen-1128349_179={1809}
                                        data-gtm-vis-total-visible-time-1128349_179={100}
                                        data-gtm-vis-has-fired-1128349_179={1}
                                    >
                                        <div className="relative-wrapper watch-wrapper">
                                            {/* <b
                ...
                <div id="related-lots" style={{ clear: 'both' }} className="unactionable-lots">
                    <div id="related-lots-title" style={{}}>
                        <h2>IF YOU LIKE THIS LOT, CHECK OUT...</h2>
                    </div>
                    <div className="lots-wrapper">
                                        ...
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                <span className="title">
                                                    Limited Edition Titos’ Vodka William Murray Golf Bag &amp; 2 JetBlue
                                                    Roundtrip Travel Certificates
                                                </span>
                                                <span className="price">Current Bid: $2,200</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div className="item" id={2522810}>
                                    ...
                                    >
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                <span className="title">
                                                    4 VIP Red Sox Tickets to a 2023 Home Game, Pre-Game Tour, 4 JetBlue
                                                    Roundtrip Travel Certificates &amp; More
                                                </span>
                                                <span className="price">Current Bid: $3,350</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    >
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                ...
                                                <span className="price">Current Bid: $3,100</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    >
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                ...
                                                <span className="price">Current Bid: $3,750</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div className="row hp-pagination">
                            <div className="medium-6 small-centered columns">
                                <div className="pagination" data-view="more-lots-button" style={{ display: 'none' }}>
                    ...
                    <div id="popular-lots-title" style={{}}>
                        <h2>CHECK OUT THESE POPULAR LOTS</h2>
                    </div>
                    <div className="lots-wrapper">
                        <div className="loading-signal">
                            <i className="icon-spin icon-spinner">&nbsp;</i>
                                    ...
                                    >
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                ...
                                                <span className="price">Current Bid: $3,255</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div className="item" id={2535000}>
                                    ...
                                    >
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                <span className="title">
                                                    2 VIP UFC 281 Tickets in Dana White’s Personal VIP Section on Nov 12
                                                    in NY
                                                </span>
                                                <span className="price">Current Bid: $5,750</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div className="item" id={2522829}>
                                    ...
                                    >
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                <span className="title">
                                                    One Year of JetBlue Mosaic Status with 2 JetBlue Roundtrip Travel
                                                    Certificates
                                                </span>
                                                <span className="price">Current Bid: $3,850</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    >
                                        <div className="item-wrapper">
                                            ...
                                            <div className="catalog-item-info">
                                                ...
                                                <span className="price">Current Bid: $4,350</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
