...
import { getAccount, getMenu } from '../../../redux/selector';
import ReactTooltip from 'react-tooltip';
import { setMenu, setOpenSidebar } from '../../../redux/actions';
          ...
          {['myProduct', 'myNotification'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: 'block' }} onClick={() => handleChangeMenu(text)}>
              ...
              >
                ...
                <ListItemText primary={text === 'myProduct' ? 'Sản phẩm' : 'Thông báo'} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
